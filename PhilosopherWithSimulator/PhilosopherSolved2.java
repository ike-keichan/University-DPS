...
public class PhilosopherSolved2 extends Process 
{
	/**
	 ...
	 * Forkを管理するフィールド
	 */
	private final Semaphore administrator = new Semaphore(1); 

	/**
	 * Philosopherのコンストラクタ
	 */
	public PhilosopherSolved2(final int id, final MessageQueue mq)
	{
		super(id, mq);
		this.id = id;
